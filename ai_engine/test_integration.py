...
def test():
    ...
    test_img_path = r"d:\Belajar_Pemrograman\WebDev\PANTAS\ai_engine\image.png"
    ...
    dict_results, annotated_img = pantas.predict(img_array, "chili_hijau_besar", roi=roi_koin)
